...
class Imitator(torch.nn.Module):
    def __init__(self, input_size=34):
        """
           Your code here.
        ...
        self.layer_1 = nn.Linear(input_size,input_size*2, bias=False)
        self.layer_2 = nn.Linear(input_size*2,input_size*2, bias=False)
        self.relu = nn.ReLU()
        self.classifier = nn.Linear(input_size*2,8, bias=False)
