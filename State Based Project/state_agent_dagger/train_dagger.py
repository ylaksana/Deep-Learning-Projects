import torch
import numpy as np
from state_agent_dagger.utils import load_dagger_data
...
def train_dagger(args, outer_epoch):
    ...
    if args.log_dir is not None:
        ...
        print(f'Train logger loaded successfully.')
    ...
    for epoch in range(0, max_epochs):
        ...
        train_logger.add_scalar('Average Loss per epoch', total_avg_loss, global_step=global_step)
        global_step += 1
